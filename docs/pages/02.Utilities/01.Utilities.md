...
▸ **resolveBulbapediaEmbeddedURL**(`pokemon`): `string`
...
Bulbapedia URL in markdown format.
...
[resolveBulbapediaEmbeddedURL]:
  /utilities/utilities#resolvebulbapediaembeddedurl
