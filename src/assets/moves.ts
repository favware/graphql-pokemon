...
export default new GraphQLCollection<string, Pokemon.Move>([
  ...
  [
    'courtchange',
    {
      ...
      category: 'Status',
      desc:
        "Switches the Mist, Light Screen, Reflect, Spikes, Safeguard, Tailwind, Toxic Spikes, Stealth Rock, Water Pledge, Fire Pledge, Grass Pledge, Sticky Web, Aurora Veil, G-Max Steelsurge, and G-Max Wildfire effects from the user's side to the target's side and vice versa.",
  ...
  [
    'gmaxsweetness',
    {
      ...
      shortDesc: "Cures team's statuses. BP scales with base move.",
  ...
  [
    'maxairstream',
    {
      ...
      shortDesc: 'User/allies: +1 Speed. BP scales with base move.',
      name: 'Max Airstream',
      pp: 5,
      priority: 0,
      target: 'Adjacent Foes',
  ...
  [
    'maxknuckle',
    {
      ...
      shortDesc: 'User/allies: +1 Attack. BP scales with base move.',
      name: 'Max Knuckle',
      pp: 5,
      priority: 0,
      target: 'Adjacent Foes',
  ...
  [
    'maxooze',
    {
      ...
      shortDesc: 'User/allies: +1 Sp.Atk. BP scales with base move.',
      name: 'Max Ooze',
      pp: 5,
      priority: 0,
      target: 'Adjacent Foes',
  ...
  [
    'maxquake',
    {
      ...
      shortDesc: 'User/allies: +1 Sp.Def. BP scales with base move.',
      name: 'Max Quake',
      pp: 5,
      priority: 0,
      target: 'Adjacent Foes',
  ...
  [
    'maxsteelspike',
    {
      ...
      shortDesc: 'User/allies: +1 Defense. BP scales with base move.',
      name: 'Max Steelspike',
      pp: 5,
      priority: 0,
      target: 'Adjacent Foes',
  ...
  [
    'noretreat',
    {
      ...
      category: 'Status',
      desc:
        'The user raises each of its stats by one stage, but it is prevented from switching out. The user can still switch out if it uses Baton Pass, Parting Shot, U-turn, or Volt Switch. If the user leaves the field using Baton Pass, the replacement will remain trapped. Can only be used once while on the field.',
  ...
  [
    'obstruct',
    {
      ...
      category: 'Status',
      desc:
        "The user is protected from most attacks made by other Pokemon during this turn, and Pokemon trying to make contact with the user have their Defense lowered by 2 stages. Non-damaging moves go through this protection. This move has a 1/X chance of being successful, where X starts at 1 and triples each time this move is successfully used. X resets to 1 if this move fails, if the user's last move used is not Baneful Bunker, Detect, Endure, King's Shield, Obstruct, Protect, Quick Guard, Spiky Shield, or Wide Guard, or if it was one of those moves and the user's protection was broken. Fails if the user moves last this turn.",
  ...
  [
    'skillswap',
    {
      ...
      category: 'Status',
      desc:
        "The user swaps its Ability with the target's Ability. Fails if either the user or the target's Ability is Battle Bond, Comatose, Disguise, Gulp Missile, Hunger Switch, Ice Face, Illusion, Multitype, Power Construct, RKS System, Schooling, Shields Down, Stance Change, Wonder Guard, or Zen Mode.",
