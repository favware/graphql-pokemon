...
export const moves = new Collection<string, PokemonTypes.Move>([
  ...
  [
    'bleakwindstorm',
    {
      ...
      basePower: '100',
      category: 'Special',
      desc: "Has a 30% chance to lower the target's Speed by 1 stage. If the weather is Heavy Rain or Rain, this move does not check accuracy. If this move is used against a Pokémon holding Utility Umbrella, this move's accuracy remains at 80%.",
  ...
  [
    'corrosivegas',
    {
      ...
      basePower: '0',
      category: 'Status',
      desc: 'The target loses its held item. This move cannot cause Pokémon with the Sticky Hold Ability to lose their held item or cause a Kyogre, Groudon, Dialga, Palkia, Giratina, Arceus, Genesect, Silvally, Zacian, Zamazenta, Paradox Pokémon, or Ogerpon to lose their Blue Orb, Red Orb, Adamant Crystal, Lustrous Globe, Griseous Core, Plate, Drive, Memory, Rusted Sword, Rusted Shield, Booster Energy, or Mask, respectively. In this case, Paradox Pokémon include every species with the Protosynthesis and Quark Drive Abilities, except Gouging Fire, Raging Bolt, Iron Boulder, and Iron Crown. Items lost to this move cannot be regained with Recycle or the Harvest Ability.',
      isNonstandard: IsNonStandard.Unobtainable,
      name: 'Corrosive Gas',
      pp: 40,
      priority: 0,
  ...
  [
    'covet',
    {
      ...
      category: 'Physical',
      contestType: 'Cute',
      desc: "If this attack was successful and the user has not fainted, it steals the target's held item if the user is not holding one. A target with the Sticky Hold Ability does not lose its held item if it has not fainted. The target's item is not stolen if it is a Blue Orb, Red Orb, Adamant Crystal, Lustrous Globe, Griseous Core, Plate, Drive, Memory, Rusted Sword, Rusted Shield, Booster Energy, or Mask held by a Kyogre, Groudon, Dialga, Palkia, Giratina, Arceus, Genesect, Silvally, Zacian, Zamazenta, Paradox Pokémon, or Ogerpon, respectively, or if the user is one of those species and the target is holding the respective item. In this case, Paradox Pokémon include every species with the Protosynthesis and Quark Drive Abilities, except Gouging Fire, Raging Bolt, Iron Boulder, and Iron Crown. Items lost to this move cannot be regained with Recycle or the Harvest Ability.",
      maxMovePower: 110,
      name: 'Covet',
      pp: 25,
      priority: 0,
  ...
  [
    'hurricane',
    {
      ...
      category: 'Special',
      contestType: 'Tough',
      desc: "Has a 30% chance to confuse the target. This move can hit a target using Bounce, Fly, or Sky Drop, or is under the effect of Sky Drop. If the weather is Heavy Rain or Rain, this move does not check accuracy. If the weather is Intense Sun or Sun, this move's accuracy is 50%. If this move is used against a Pokémon holding Utility Umbrella, this move's accuracy remains at 70%.",
      maxMovePower: 140,
      name: 'Hurricane',
      pp: 10,
      priority: 0,
  ...
  [
    'knockoff',
    {
      ...
      category: 'Physical',
      contestType: 'Clever',
      desc: "This move's power is multiplied by 1.5 if the target is holding an item, and the target loses its held item if the user has not fainted. A target with the Sticky Hold Ability does not lose its held item if it has not fainted. This move does not increase in power or remove the target's item if it is a Blue Orb, Red Orb, Adamant Crystal, Lustrous Globe, Griseous Core, Plate, Drive, Memory, Rusted Sword, Rusted Shield, Booster Energy, or Mask held by a Kyogre, Groudon, Dialga, Palkia, Giratina, Arceus, Genesect, Silvally, Zacian, Zamazenta, Paradox Pokémon, or Ogerpon, respectively, or if the user is one of those species and the target is holding the respective item. In this case, Paradox Pokémon include every species with the Protosynthesis and Quark Drive Abilities, except Gouging Fire, Raging Bolt, Iron Boulder, and Iron Crown. Items lost to this move cannot be regained with Recycle or the Harvest Ability.",
      maxMovePower: 120,
      name: 'Knock Off',
      pp: 20,
      priority: 0,
  ...
  [
    'leechseed',
    {
      ...
      category: 'Status',
      contestType: 'Clever',
      desc: "The Pokémon at the user's position steals 1/8 of the target's maximum HP, rounded down, at the end of each turn. If Big Root is held by the recipient, the HP recovered is 1.3× normal, rounded half down. If the target uses Baton Pass, the replacement will continue being leeched. If the target switches out or uses Mortal Spin or Rapid Spin successfully, the effect ends. Grass-type Pokémon are immune to this move on use, but not its effect.",
      name: 'Leech Seed',
      pp: 10,
      priority: 0,
  ...
  [
    'magnitude',
    {
      ...
      pp: 30,
      priority: 0,
      shortDesc: 'Hits adjacent Pokémon. Power varies; 2× on Dig.',
      target: 'All Adjacent',
      type: 'Ground'
    }
  ],
  ...
  [
    'sandsearstorm',
    {
      ...
      basePower: '100',
      category: 'Special',
      desc: "Has a 20% chance to burn the target. If the weather is Heavy Rain or Rain, this move does not check accuracy. If this move is used against a Pokémon holding Utility Umbrella, this move's accuracy remains at 80%.",
      name: 'Sandsear Storm',
      pp: 10,
      priority: 0,
  ...
  [
    'switcheroo',
    {
      ...
      category: 'Status',
      contestType: 'Clever',
      desc: "The user swaps its held item with the target's held item. Fails if both the user and the target have no held item, or if the user is trying to give or take a Blue Orb, Red Orb, Adamant Crystal, Lustrous Globe, Griseous Core, Plate, Drive, Memory, Rusted Sword, Rusted Shield, Booster Energy, or Mask to or from a Kyogre, Groudon, Dialga, Palkia, Giratina, Arceus, Genesect, Silvally, Zacian, Zamazenta, Paradox Pokémon, or Ogerpon, respectively. In this case, Paradox Pokémon include every species with the Protosynthesis and Quark Drive Abilities, except Gouging Fire, Raging Bolt, Iron Boulder, and Iron Crown. The target is immune to this move if it has the Sticky Hold Ability.",
      name: 'Switcheroo',
      pp: 10,
      priority: 0,
  ...
  [
    'wildboltstorm',
    {
      ...
      basePower: '100',
      category: 'Special',
      desc: "Has a 20% chance to paralyze the target. If the weather is Heavy Rain or Rain, this move does not check accuracy. If this move is used against a Pokémon holding Utility Umbrella, this move's accuracy remains at 80%.",
      name: 'Wildbolt Storm',
      pp: 10,
      priority: 0,
